...
trimmed <- trimmed %>% mutate(question_type = 
  case_when(
    ...
    question %in% q_list$dark_blue ~ "dark_blue",
    question %in% q_list$sky_blue ~ "sky_blue",
...
# data_vis_loop_all <- function(df) {
#   x <- 0
#   while (x < 3) {
#     for (i in unique(df$classroom)) {
#     data_vis_loop(df, i)
#     x <- x + 1
#     }
#   }
